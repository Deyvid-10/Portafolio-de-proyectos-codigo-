...
function Contactos() {
    ...
    <div id="espacio_contactos">
        <div id="contenedor_contactos">
            
            <h4>Contactos</h4>

            <div id="contenedor_elementos_contactos">
                <div className="elemento_contactos">
                    <img src={correo} alt="icono_correo"></img>
                    <h3 id="correo">marmolejodeyvid<span> </span>@gmail.com</h3>
                </div>
                <div className="elemento_contactos">
                    <img src={telefono} alt="icono_correo"></img>
                    <h3>(809)-442-0389</h3>
                </div>
                <div className="elemento_contactos">
                    <img src={telefono} alt="icono_correo"></img>
            ...
            <div>
                <a href="https://www.linkedin.com/in/deyvid-marmolejo-91a7a2273/" target="_blank">
                    <svg id="likedin_contactos" href="https://www.youtube.com/" className="iconos" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://github.com/Deyvid-10" target="_blank">
                ...
                <svg id="documento_contactos" className="iconos" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
