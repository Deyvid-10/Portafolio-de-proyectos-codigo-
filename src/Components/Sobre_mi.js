            ...
            <div className="pt-28 lg:w-8/12 md:w-10/12 lg:px-0 px-4 mx-auto">
                <div className="lg:flex flex-row-reverse">
                    <div className="lg:block md:flex block md:mb-6 lg:mx-5">
                        ...
                        <div className="ml-5 lg:block block md:flex justify-evenly items-center md:py-10 py-2 md:w-full">
                            <div>
                                ...
                                <a className="flex items-center group my-4 text-sm transition font-medium hover:text-teal-400" href="https://www.linkedin.com/in/deyvid-marmolejo-91a7a2273/" target="_blank" rel="noreferrer">
                                ...
                                <a className="flex items-center group my-4 text-sm transition font-medium hover:text-teal-400" href={`${process.env.PUBLIC_URL}/CV - Deyvid Marmolejo.pdf`} download="CV - Deyvid Marmolejo.pdf" rel="noreferrer">
                            ...
                            <div className="lg:w-full lg:h-1 lg:border-t lg:my-8 md:w-1 md:h-full md:border-l w-full h-1 border-t my-2 border-zinc-200"></div>
                            <div>
                                <a className="flex items-center group my-4 text-sm transition font-medium hover:text-teal-400" href="mailto:marmolejodeyvid@gmail.com" rel="noreferrer">
                                    ...
                                    <p className="ml-2">marmolejodeyvid@gmail.com</p>
                                </a>
                                <a className="flex items-center group my-4 text-sm transition font-medium hover:text-teal-400" href="tel:+18094420389" rel="noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500" viewBox="0 0 16 16">
                                    <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                                    <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
                                    </svg>
                                    <p className="ml-2">(809)-442-0389</p>
                                </a>
                                <a className="flex items-center group my-4 text-sm transition font-medium hover:text-teal-400" href="tel:+18295878292" rel="noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500" viewBox="0 0 16 16">
                                    <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                                    <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
                                    </svg>
                                    <p className="ml-2">(829)-587-8292</p>
                                </a>
                            </div>
                        </div>
                    </div>
